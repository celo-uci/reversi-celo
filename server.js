...
io.on('connection', (socket) => {
   ...
   */
    ...
    socket.on('play_token', (payload) => {
        ...
        // Make sure the current play is coming from expected player
        if(
...
// Code related to game state
    // Check if a game with game_id exists
...
// return true if r + dr support playing at r and c + dc supports playing at c
